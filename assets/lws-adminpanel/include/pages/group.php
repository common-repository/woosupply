...
class Group
{
	...
	public static function format()
	{
		return array(
			...
			'text'				=> \LWS\Adminpanel\Internal\Pages::format('text', true, 'string', "A free text displayed at top of the group, after the title."),
			...
			'color'				=> \LWS\Adminpanel\Internal\Pages::format('color', true, 'string', "special color for the group"),
	...
	protected function groupTitleLine()
	{
		...
		if (empty($this->title))
			...
			if(isset($this->icon) && !empty($this->icon))
			{
				...
				$icon = "<div class='group-icon {$this->icon}' data-icon='{$this->icon}'></div>";
			}
