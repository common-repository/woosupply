...
abstract class Page
{
	...
	public static function format()
	{
		return array(
			...
			'text'		=> \LWS\Adminpanel\Internal\Pages::format('text',		true, 'string', "A free text displayed at top of the page, after the title banner."),
			'subtext'	=> \LWS\Adminpanel\Internal\Pages::format('subtext',	true, 'string', "A free text displayed after the tab line but before tab content."),
			'description'=> \LWS\Adminpanel\Internal\Pages::format('description',true, 'string', "An html text explaining in details the purpose of the page"),
