...
class Admin
{
	...
	function registerScripts()
	{
		...
		\wp_localize_script('lws-admin-interface', 'button_texts', array(
			...
			'showset' => __("Show Advanced Settings", 'lws-adminpanel'),
			'hideset' => __("Hide Advanced Settings", 'lws-adminpanel'),
		));
		...
		\wp_register_script('lws-lac-input',          LWS_ADMIN_PANEL_JS . '/controls/lac/lacinput.js', array('lws-lac-model'), LWS_ADMIN_PANEL_VERSION, true );
		...
		\wp_register_style('lws-lac-input-style',     LWS_ADMIN_PANEL_CSS . '/controls/lac/lacinput.css', array('lws-adminpanel-css'), LWS_ADMIN_PANEL_VERSION);
